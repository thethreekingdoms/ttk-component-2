...
import AnchorComponent from './components/anchor/ie8'
...
import MessageComponent from './components/toast'
import ToastComponent from './components/toast'
import ModalComponent from './components/modal/ie8'
...
import InputComponent from './components/input/ie8'
import SelectComponent from './components/select/ie8'
...
import LocaleWrapperComponent from './components/localeWrapper/ie8'
import ListComponent from './components/list/ie8'
import ShortKeyComponent from './components/shortcut'
import SearchComponent from './components/search/ie8'
import FormDecoratorComponent from './decorator/form/index'
import GridDecoratorComponent from './decorator/grid/index'
...
import TableOperateComponent from './components/tableOperate'
import TableOperate2Component from './components/tableOperate2'
...
import AddressComponent from './components/address/index'
import PrintOptionComponent from './components/printOption/index'
...
import ColumnsSettingComponent from './components/columnsSetting/ie8Input'
import RowComponent from './components/row/index'
import ColComponent from './components/col/index'
import StepComponent from './components/intro/index'
...
export const localeWrapper = LocaleWrapperComponent
export const List = ListComponent
export const ShortKey = ShortKeyComponent
export const SearchCard = SearchComponent
